...
export class AvatarVAT implements CreateSceneClass {
    createScene = async (
        engine: Engine,
        ...
        (npcMesh.material as StandardMaterial).diffuseTexture = new Texture('./Avatar_Texture.jpg', scene);
        const vat = new VAT(
            "VATavatar",
            scene,
            npcMesh,
